...
Composant Random Forest pour classification
et régression.
=========================================================
"""
    ...
    def fit(
        ...
        *,
        ...
        if selected.isna().any().any():
            raise ValueError(
                "RandomForestModel ne peut pas être "
        ...
        if task == "regression":
            ...
            if not pd.api.types.is_numeric_dtype(
                ...
                raise ValueError(
                    "La cible d'une Random Forest de "
            ...
            if not np.isfinite(
                ...
                raise ValueError(
                    "La variable cible contient des "
                    "valeurs non finies."
                )
        ...
        try:
            ...
            raise ValueError(
                "min_samples_leaf doit être un entier."
            ) from exc

        if min_samples_leaf < 1:
            raise ValueError(
                "min_samples_leaf doit être "
                "au moins égal à 1."
            )
